...
typedef enum {
    ...
    TOKEN_IF, TOKEN_OF, TOKEN_VOID, TOKEN_NOT, TOKEN_OR,
    TOKEN_SAY, TOKEN_RETURN, TOKEN_YIELD, TOKEN_TO, TOKEN_TRUE, TOKEN_WHILE,
    TOKEN_ASK, TOKEN_END, TOKEN_LEN, TOKEN_TYPE, TOKEN_APPEND, TOKEN_TO_NUM,
